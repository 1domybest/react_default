...
export const tokenRefresh = async () => {
    try {
        ...
        const accessToken:string = response.headers[HeaderKeys.Authorization].substring(7)
        // 서버에서 받은 새로운 엑세스 토큰을 기본 헤더에 설정
        jsonPlaceholderRequest.defaults.headers.common[HeaderKeys.Authorization] = accessToken;
