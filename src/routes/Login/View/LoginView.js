...
const LoginViewModel_tsx_1 = __importDefault(require("../ViewModel/LoginViewModel.tsx"));
const react_1 = require("react");
const react_router_dom_1 = require("react-router-dom");
const LoginView = (0, mobx_react_lite_1.observer)(() => {
    const navigate = (0, react_router_dom_1.useNavigate)();
    const vm = (0, react_1.useRef)(new LoginViewModel_tsx_1.default());
    (0, react_1.useEffect)(() => {
        ...
        <Container>
            <MainBox>
                ...
                <LoginBox>
                    ...
                    <LoginTitle>
                        <react_router_dom_1.Link to="/main">
                            이메일을 입력하세요 테스트
...
const Container = styled_components_1.default.div `
    ...
    margin-bottom: 50px;
`;
const MainBox = styled_components_1.default.div `
    width: 580px;
    min-width: 580px;
    display: flex;
    flex-direction: column;
...
`;
const LoginBox = styled_components_1.default.div `
    width: 100%;
    height: 100%;
    padding: 56px 72px;
    border: none;
    ...
    background-color: #f9f9f9;
`;
const LogoBox = styled_components_1.default.div `
    img {
        min-width: 97px;
        width: 97px;
        margin-bottom: 6px;
...
`;
const LoginTitle = styled_components_1.default.h3 `
    color: black;
    font-weight: bold;
    margin-bottom: 12px;
`;
const Description = styled_components_1.default.p `
    color: black;
`;
const FormBox = styled_components_1.default.form `
    width: 100%;
    display: flex;
    flex-direction: column;
`;
...
`;
const SNSLoginButtons = styled_components_1.default.div `
    display: flex;
    flex-direction: column;
...
const Divider = styled_components_1.default.div `
    ...
    width: 100%; // 가로 길이
`;
const PolicyDescription = styled_components_1.default.div `
...
`;
const CTALogoTwo = styled_components_1.default.div `
    width: 100%;
    display: flex;
    flex-direction: column;
    align-items: center;
...
`;
const Footer = styled_components_1.default.p `
    padding: 20px 50px;
    display: flex;
    flex-wrap: wrap;
    justify-content: center;
...
`;
const CompanyInfoA = (0, styled_components_1.default)(react_router_dom_1.Link) `
    color: rgb(95 97 102);
    opacity: 0.8;
